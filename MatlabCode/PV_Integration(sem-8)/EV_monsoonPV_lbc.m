...
DM = normrnd(41,8,[1,nEV]);  % Daily Mileage following Normal Distribution 
                             % Mean=55, S.D.=10, No of Random Variables supposed to be generated=10
FTD = normrnd(15,5.41,[1,nEV]);  % 1st Trip Distance following Normal Distribution

Tin = normrnd(11,1.2,[1,nEV]);  % Arrival Time following Normal Distribution
Tout = normrnd(18,1.2,[1,nEV]); % Departure Time following Normal Distribution

while max(Tout)>24    % Tout shouldn't go beyond 24hrs
    Tout = normrnd(22,1.2,[1,nEV]);  %if goes, again generates Random Variable
end

rate_USEP_MWh1 = [52.185	48.42375	44.145	41.3625	39.70125	39.37125	39.40875	39.16875	37.5675	37.53	39.36375	39.37875	39.6675	42.4275	48.35625	52.22625	56.925	75.2925	52.3575	42.4525	41.09	37.94	36.5975	34.7175	48.345	52.23375	52.26	34.6125	38.09625	31.99125	50.0775	53.55375	53.55375	54.60375	56.8875	154.82025	171.132	203.1315	298.80825	298.818	298.76925	298.8375	230.46075	180.18975	147.85875	139.152	136.00275	135.915
