...
%........ BEV=>20%=>'1'____PHEV-40=>30%=>'2'____PHEV-30=>50%=>'3'
    for i=1:nEV
...
Tin = normrnd(16,1.2,[1,nEV]);  % Arrival Time following Normal Distribution
Tout = normrnd(22,1.2,[1,nEV]); % Departure Time following Normal Distribution

while max(Tout)>24    % Tout shouldn't go beyond 24hrs
    Tout = normrnd(22,1.2,[1,nEV]);  %if goes, again generates Random Variable
end

rate_USEP_MWh1 = [139.16 129.13 117.72 110.30 105.87 104.99 105.09 104.45 100.18 100.08 104.97 105.01 105.78 113.14 128.95 139.27 151.80 200.78 209.43 169.81 164.36 151.76 146.39 138.87 128.92 139.29 139.36 92.30 101.59 85.31 133.54 142.81 142.81 145.61 151.70 158.79 175.52 208.34 306.47 306.48 306.43 306.50 236.37 184.81 151.65 142.72 139.49 139.40];
